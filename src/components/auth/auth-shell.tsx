...
export function AuthShell({ children, maxWidth = "max-w-[28rem]", className }: AuthShellProps) {
  return (
    <main className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#050806] font-sans selection:bg-[#345b41] selection:text-white py-12">
      ...
      <div className="absolute inset-0 z-0">
        <div 
          className="absolute -top-[10%] left-[10%] h-[40rem] w-[40rem] animate-pulse rounded-full bg-[#1b3022]/40 blur-[120px] mix-blend-screen" 
          style={{ animationDuration: '8s' }} 
        />
        <div 
          className="absolute bottom-[0%] right-[-10%] h-[35rem] w-[35rem] animate-pulse rounded-full bg-[#27452e]/30 blur-[100px] mix-blend-screen" 
          style={{ animationDuration: '10s' }} 
        />
        <div 
          className="absolute left-[30%] top-[40%] h-[25rem] w-[25rem] animate-pulse rounded-full bg-[#132418]/50 blur-[80px] mix-blend-screen" 
      ...
      <div className={cn("relative z-10 w-full px-6 lg:px-8", maxWidth, className)}>
        <Link
          href="/"
