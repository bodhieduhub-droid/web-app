...
const dummyJobs = [
  {
    ...
    summary:
      "A concise opening summary covering vacancies, timing, and the details aspirants should notice early.",
    published_at: new Date().toISOString(),
  },
  {
    id: "job-2",
    type: "job",
    title: "Kerala PSC: Assistant Engineer (Civil)",
    summary:
      "A practical brief on eligibility, department context, and application timing for interested candidates.",
    published_at: new Date(Date.now() - 86400000).toISOString(),
  },
  {
    id: "job-3",
    type: "job",
    title: "IBPS PO Prelims Expected Dates",
    summary:
      "A quick update on the expected exam window and how aspirants should prepare their schedule around it.",
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <h1 className="max-w-3xl font-serif text-[3.35rem] leading-[0.92] text-[#18281d] md:text-[4.8rem] lg:text-[5.3rem]">
                Curated openings for focused aspirants.
              </h1>
              <p className="max-w-lg text-base leading-7 text-[#405042] md:text-lg">
                Public job and exam updates from Bodhi to help aspirants stay informed without adding noise to their preparation.
              </p>
            </div>
              ...
              <div className="relative space-y-5">
                <div className="border-b border-white/10 pb-5">
                  ...
                  <p className="mt-2 max-w-sm font-serif text-[2rem] leading-tight">
                    Relevant opportunities without the clutter.
                  </p>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:py-24">
        <div className="mb-12 max-w-2xl">
          ...
          <h2 className="mt-4 font-serif text-4xl leading-tight text-[#1b3022] md:text-5xl">
            Useful updates, easier to track.
          </h2>
        </div>

        <div className="grid gap-6">
          {displayJobs.map((job) => (
            <article key={job.id} className="rounded-[2rem] border border-[#d8ddcf] bg-[#fffdf7] p-8 shadow-[0_18px_45px_rgba(39,69,46,0.06)]">
              {(() => {
                const href = getPublicPostHref(job);
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div className="border-t border-[#d8ddcf] pt-5 lg:border-t-0 lg:pt-0">
                  <Link
                    href={href}
        ...
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[2.8rem] border border-[#d8ddcf] bg-[linear-gradient(135deg,#fffdf7_0%,#f3efe2_48%,#e4eddb_100%)] p-10 shadow-[0_20px_60px_rgba(39,69,46,0.08)] md:p-14">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 font-serif text-4xl leading-tight text-[#1b3022] md:text-5xl">
                Stay informed, then prepare in a better environment.
              </h2>
              <p className="mt-5 text-base leading-8 text-[#556455]">
                Use these updates as input, then move your preparation into the Bodhi Reading Room for better daily consistency.
              </p>
            </div>
