...
export default async function StaffOnboardStudentPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-[11px] font-bold uppercase tracking-[0.32em] text-[#6d7c6c]">Staff Dashboard</p>
          <h1 className="text-3xl font-black text-[#1b3022]">Manual Onboarding</h1>
        </div>
      </div>

      <StudentOnboardingForm seats={seats ?? []} settings={settings} backUrl="/staff/students" />
    </div>
  );
}
