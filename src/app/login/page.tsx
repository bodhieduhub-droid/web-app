      ...
      <section className="border-b border-[#d5d2c6] bg-[linear-gradient(135deg,#f3f0e7_0%,#ece6d8_45%,#e5eddc_100%)] px-6 py-16 lg:py-20">
        <div className="relative mx-auto max-w-6xl space-y-8">
          ...
          <form
            ...
            className="space-y-6 rounded-[2rem] border border-[#d8ddcf] bg-[#fffdf7] p-8 shadow-[0_18px_45px_rgba(39,69,46,0.08)] lg:p-8"
          >
            ...
            <label className="block space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  className="w-full rounded-2xl border border-[#d8ddcf] bg-white px-11 py-4 text-sm font-semibold text-[#1b3022] outline-none transition focus:border-[#1b3022]"
                  value={email}
            ...
            {error ? (
              <div className="rounded-2xl border border-[#e7d0d0] bg-[#fff5f5] px-4 py-3 text-sm font-semibold text-[#8a2f2f]">
                {error}
              </div>
            ) : null}
